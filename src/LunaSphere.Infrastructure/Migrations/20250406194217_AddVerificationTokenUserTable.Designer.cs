...
namespace LunaSphere.Infrastructure.Migrations
{
    ...
    [Migration("20250406194217_AddVerificationTokenUserTable")]
    partial class AddVerificationTokenUserTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LunaSphere.Domain.RefreshTokens.RefreshToken", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2025, 4, 6, 19, 42, 17, 209, DateTimeKind.Utc).AddTicks(5560));
            ...
            modelBuilder.Entity("LunaSphere.Domain.Users.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 4, 6, 19, 42, 17, 209, DateTimeKind.Utc).AddTicks(8120));
