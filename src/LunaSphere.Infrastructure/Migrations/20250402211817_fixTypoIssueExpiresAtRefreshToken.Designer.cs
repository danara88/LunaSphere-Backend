...
namespace LunaSphere.Infrastructure.Migrations
{
    ...
    [Migration("20250402211817_fixTypoIssueExpiresAtRefreshToken")]
    partial class fixTypoIssueExpiresAtRefreshToken
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LunaSphere.Domain.RefreshTokens.RefreshToken", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2025, 4, 2, 21, 18, 17, 482, DateTimeKind.Utc).AddTicks(7460));
            ...
            modelBuilder.Entity("LunaSphere.Domain.Users.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 4, 2, 21, 18, 17, 482, DateTimeKind.Utc).AddTicks(9710));
