...
namespace LunaSphere.Infrastructure.Migrations
{
    ...
    [Migration("20250328030947_AddFirstVerificationSendColumn")]
    partial class AddFirstVerificationSendColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LunaSphere.Domain.RefreshTokens.RefreshToken", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2025, 3, 28, 3, 9, 47, 633, DateTimeKind.Utc).AddTicks(7060));
            ...
            modelBuilder.Entity("LunaSphere.Domain.Users.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 3, 28, 3, 9, 47, 633, DateTimeKind.Utc).AddTicks(9210));
